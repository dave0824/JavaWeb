  ...
  <body>
    ...
    <c:forEach items="${list }" var="category">
    	<tr bordercolor="rgb(78,78,78)">
    		...
    		<td>
    		  <a href="<c:url value='/admin/CategoryServlet?method=modPre&cid=${category.cid }'/>">修改</a> |
    		  <a href="<c:url value='/admin/CategoryServlet?method=delPre&cid=${category.cid }'/>">删除</a>
    		</td>
    	</tr>
    </c:forEach>
    </table>
