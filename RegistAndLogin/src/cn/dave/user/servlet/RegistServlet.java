 ...
 */
@WebServlet(description = "registServlet", urlPatterns = { "/RegistServlet" })
public class RegistServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(errors != null && errors.size()>0){
			...
			RequestDispatcher rs=request.getRequestDispatcher("/user/Regist.jsp");
		...
		try{
			...
			response.getWriter().print("<h1>注册成功</h1><a href='"+request.getContextPath()+ "/user/Login.jsp"+"'>点击这里返回登录</a>");
